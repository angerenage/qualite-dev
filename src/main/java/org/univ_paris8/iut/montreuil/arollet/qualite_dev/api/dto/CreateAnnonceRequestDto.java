...
@Schema(name = "CreateAnnonceRequest", description = "Payload to create a new annonce")
public class CreateAnnonceRequestDto {
	@Schema(example = "Studio meublé proche métro")
	@NotBlank(message = "title is required.")
	@Size(max = 64, message = "title must contain at most 64 characters.")
	private String title;

	@Schema(example = "Studio 25m2 rénové, charges incluses.")
